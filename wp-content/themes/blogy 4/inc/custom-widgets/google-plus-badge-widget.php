...
class mts_googleplus_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'mts_googleplus', 'description' => __('Adds a beautiful Google Plus badge widget.','mythemeshop'));

		$control_ops = array('id_base' => 'google-badge-box');

		$this->WP_Widget('google-badge-box', __('[ CUSTOM ] Google+ Widget ','mythemeshop'), $widget_ops, $control_ops);
	}
	...
	{
		$defaults = array('title' => __('Find us on Google Plus','mythemeshop'), 'page_url' => '', 'width' => '300', 'color_scheme' => 'light', 'gp_layout' => 'portrait', 'page_type' => 'profile', 'cover_photo' => true, 'tagline' => true);
