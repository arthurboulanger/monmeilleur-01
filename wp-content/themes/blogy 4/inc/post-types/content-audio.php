...
$files = rwmb_meta( 'theme2035_file_advanced', 'type=file' );
...
jQuery(document).ready(function(){jQuery("#jquery_jplayer_<?php echo $rand; ?>").jPlayer({ready:function(){jQuery(this).jPlayer("setMedia",{title:"Audio",mp3:"<?php echo $audio_url; ?>?<?php echo $rand; ?>"})},swfPath:"<?php echo THEMEROOT; ?>/js",supplied:"mp3",wmode:"window",cssSelectorAncestor:"#jp_container_<?php echo $rand; ?>",smoothPlayBar:true,keyEnabled:true,remainingDuration:true,toggleDuration:true})})
</script>

<!--
<script type="text/javascript">
jQuery(document).ready(function(){
    jQuery("#jquery_jplayer_<?php echo $rand; ?>").jPlayer({
        ready: function () {
            jQuery(this).jPlayer("setMedia", {
                title: "Audio",
                mp3: "<?php echo $audio_url; ?>?<?php echo $rand; ?>"
            });
        },
        swfPath: "<?php echo THEMEROOT; ?>/js",
        supplied: "mp3",
        wmode: "window",
        cssSelectorAncestor: "#jp_container_<?php echo $rand; ?>",
        smoothPlayBar: true,
        keyEnabled: true,
...
-->
    ...
    <?php if(!is_single()){ ?><div class="blog-post clearfix"><?php }else { ?><div class="blog-post-single blog-post-single-style clearfix"><?php } ?>
            ...
            <div class="post-type-icon">
                <i title="<?php echo __("Audio Post Format","2035Themes-fm"); ?>" class="fa fa-file-audio-o"></i>
            </div>
            ...
            <div class="media-materials">
                ...
                $audio = get_post_meta( get_the_ID(), 'theme2035_audio', true );
                    ...
                    if($theme_prefix['sidebar-type'] == "none" ){ $image_size = "full-screen"; } else { $image_size="full"; } ?>
                ...
                if($audio != "" ){
                    echo get_post_meta( get_the_ID(), 'theme2035_audio', true );
                } else if($audio_url  != ""){

                     ?>
                <div class="blog-post-audio clearfix" style="background : url('<?php echo $image; ?>'); ">
                    <div id="jquery_jplayer_<?php echo $rand; ?>" class="jp-jplayer"></div>
                    <div id="jp_container_<?php echo $rand; ?>" class="jp-audio">
