...
************************************************************************************************** -->
    ...
    <article <?php post_class('clearfix'); ?> id="post-<?php the_ID(); ?>">
        ...
        $image = $image[0]; ?>
        <?php endif; ?>
        <div class="blog-post-link clearfix" style="background : url('<?php echo $image; ?>') #000;">
        	<div class="link-background">
            	<?php the_content(); ?>
            	<div class="link-more"><a title="<?php echo __('Read More','2035Themes-fm'); ?>" href="<?php the_permalink(); ?>"><?php echo $post_date = the_time('F j'); ?> </a> </div>
            </div>
        </div>
    </article>
	...
	<?php } else { ?>
	 ...
	 <article <?php post_class('clearfix'); ?> id="post-<?php the_ID(); ?>">
            ...
            <div class="post-type-icon">
                <i title="<?php echo __("Link Post Format","2035Themes-fm"); ?>" class="fa fa-external-link"></i>
            </div>
            <?php if (is_sticky()) { ?> <span class="sticky-post"><i class="fa fa-bookmark"></i></span> <?php } ?>
            <div class="media-materials">
		        <div class="blog-post-link clearfix" style="background : url('<?php echo $image; ?>') ewrewrtwqrt; ">
		        	<div class="link-background">
		            	<?php the_content(); ?>
		            </div>
		        </div>          
            ...
            <div class="post-content clearfix">
                    <div class="post-tools link-line clearfix">
                        <div class="col-lg-6">
                            <div class="pull-left">
