    ...
    public function widget($args, $instance) {
        ...
        if(!empty($tp_twitter_plugin_tweets)){
            ...
            foreach($tp_twitter_plugin_tweets as $tweet){
                print '<div class="tweet-box clearfix"><div class="user-twitter-avatar pull-left"><a href="http://twitter.com/'.$username.'"><img width="48" height="48" class="img-circle" src="'.$image.'" alt="" /></a></div><div class="tweet-content pull-left">'.'<div class="tweet-title"><a href="http://twitter.com/'.$username.'">'.$username.'</a></div><p>'.convert_links($tweet['text']).'</p><div class="time">'.relative_time($tweet['created_at']).'</div></div></div>';
                if($count == $instance['tweetsnumber']){ break; }
                $count++;
            }
            ?>
                <div class="follow-button clearfix"><a href="https://twitter.com/<?php echo $instance['username']; ?>" class="twitter-follow-button" data-show-count="false"data-lang="en"><?php _e('Follow me','theme2035'); ?></a>
