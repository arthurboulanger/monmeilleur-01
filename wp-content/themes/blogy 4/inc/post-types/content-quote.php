...
************************************************************************************************** -->
    ...
    <article <?php post_class('clearfix'); ?> id="post-<?php the_ID(); ?>">
        <div class="blog-post-quote clearfix" style="background : url('<?php echo $image; ?>') #000;">
                <?php the_content(); ?>
                <div class="quote-more"><a title="<?php echo __('Read More','2035Themes-fm'); ?>" href="<?php the_permalink(); ?>"><?php echo $post_date = the_time('F j'); ?> </a> </div>
        </div>
    </article>
    ...
    <?php if(!is_single()){ ?><div class="blog-post clearfix"><?php }else { ?><div class="blog-post-single blog-post-single-style clearfix"><?php } ?>
            ...
            <div class="post-type-icon">
                <i title="<?php echo __("Quote Post Format","2035Themes-fm"); ?>" class="fa fa-quote-left"></i>
            </div>
            ...
            <div class="post-content clearfix">
                    <div class="post-tools quote-line clearfix">
                        <div class="col-lg-6">
                            <div class="pull-left">
