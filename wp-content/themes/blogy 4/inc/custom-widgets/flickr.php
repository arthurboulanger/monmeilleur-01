...
add_action( 'widgets_init', 'theme2035_flickr' );

/* Function that registers our widget. */
function theme2035_flickr() {
    register_widget( 'theme2035_flickr' );
}


class theme2035_flickr extends WP_Widget {
function theme2035_flickr() {
        /* Widget settings. */
        $widget_ops = array( 'classname' => '[ CUSTOM ] Flickr Widget ', 'description' => 'Displays photos from Flickr based on your tags.' );

        /* Widget control settings. */
        $control_ops = array( 'width' => 400,  'id_base' => 'simple-flickr-photos-widget' );

        /* Create the widget. */
        $this->WP_Widget( 'simple-flickr-photos-widget', '[ CUSTOM ] Flickr Widget ', $widget_ops, $control_ops );
    }
...
$instance['flickr_gallery_tag'] = strip_tags($new_instance['flickr_gallery_tag']);
    ...
    function form( $instance ) {
        ...
        $defaults = array( 'title' => 'Flickr Widget [ CUSTOM ]', 'flickr_gallery_source' => '2', 'flickr_gallery_tag' => 'nature', 'flickr_gallery_count' => '6','flickr_gallery_display'=>'2','flickr_gallery_size'=>'0','flickr_gallery_use_tag'=>'Yes' );
