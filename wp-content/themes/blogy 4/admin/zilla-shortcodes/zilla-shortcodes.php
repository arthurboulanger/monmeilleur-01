...
class ZillaShortcodes {
    ...
    {	
    	...
    	define('ZILLA_TINYMCE_URI', get_template_directory_uri().'/admin/zilla-shortcodes/tinymce');
		define('ZILLA_TINYMCE_DIR', get_template_directory_uri().'/admin/zilla-shortcodes/tinymce');
	...
	function admin_init()
	{
		...
		wp_localize_script( 'jquery', 'ZillaShortcodes', array('plugin_folder' => get_template_directory_uri() .'/admin/zilla-shortcodes') );
	}
